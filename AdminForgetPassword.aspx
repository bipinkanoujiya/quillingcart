...
<nav class="navbar navbar-default navbar-fixed-top">
 ...
 <asp:Button ID=handcrafttextbutton runat="server" Text="Subscribe" CssClass="btn btn-info btn-lg" Width="110" Height="40" ForeColor="White"></asp:Button>
        ...
        <style>
          ...
          #enteremailid,#enternewpassword,#Reenternewpassword{
 ...
 .section-header .section-title {
   ...
   margin-top:100px;
    ...
    border-radius:25px;
            ...
            #textboxname,#textemail,#textmobile{
                height: 34px;
                padding: 6px 12px;
                border-radius:5px;
            }
...
<br /> <br /> <br />
  ...
  <div class="Loginbox" >  
      <br />
       <asp:Label ID="enteremailid" runat="server" Text="Email"></asp:Label>
        <asp:TextBox ID="textemailid" runat="server" placeholder="Enter Email" CssClass="form-control" Width="100%"></asp:TextBox>

        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="textemailid" ErrorMessage="Enter Email " ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ForeColor="#CC0000">  Email should be as Bipinkanouj8@gmail.com</asp:RegularExpressionValidator>
        <br />
        <asp:Label ID="enternewpassword" runat="server" Text="Enter New Password"></asp:Label>
        <asp:TextBox ID="textenterpassword" CssClass="form-control" Width="100%" placeholder="Enter New Password" runat="server"></asp:TextBox>
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="textenterpassword" ErrorMessage="Enter Name" ForeColor="#CC0000">* Required Field</asp:RequiredFieldValidator>
       <br />
     
        <asp:Label ID="Reenternewpassword" runat="server" Text="Re-Enter Password"></asp:Label>
        <asp:TextBox ID="textReenterpassword" runat="server" CssClass="form-control" placeholder="Re-Enter Password" Width="100%"></asp:TextBox>
&nbsp;&nbsp;
        <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="textenterpassword" ControlToValidate="textReenterpassword" ErrorMessage="Password Should be Same" ForeColor="#CC3300"> * Password Should be Same</asp:CompareValidator>
        <br />
       
        
     
      
        <asp:Button ID="forgetsubmitbtn" runat="server"  Text="Submit"  CssClass="btn btn-info btn-lg btn-block" Width="100%" />
   <br />
