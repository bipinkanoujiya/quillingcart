<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserChangePassword.aspx.cs" Inherits="UserChangePassword" %>
...
<nav class="navbar navbar-default navbar-fixed-top">
 ...
 .section-header .section-title {
   ...
   #userenteremailid,#userenternewpassword,#userReenternewpassword{
            ...
            text-align:center;
              ...
              #usertextemailid,#usertextenterpassword,#usertextReenterpassword{
                height: 34px;
                padding: 6px 12px;
                border-radius:5px;
            }
...
<br /> <br /> <br />
  ...
  <div class="Loginbox" >  
      <br />
       <asp:Label ID="userenteremailid" runat="server" Text="Email"></asp:Label>
        <asp:TextBox ID="usertextemailid" runat="server" placeholder="Enter Email" CssClass="form-control" Width="100%"></asp:TextBox>

        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="usertextemailid" ErrorMessage="Enter Email " ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ForeColor="#CC0000">  Email should be as Bipinkanouj8@gmail.com</asp:RegularExpressionValidator>
        <br />
        <asp:Label ID="userenternewpassword" runat="server" Text="Enter New Password"></asp:Label>
        <asp:TextBox ID="usertextenterpassword" CssClass="form-control" Width="100%" placeholder="Enter New Password" runat="server"></asp:TextBox>
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="usertextenterpassword" ErrorMessage="Enter Password" ForeColor="#CC0000">* Required Field</asp:RequiredFieldValidator>
       <br />
     
        <asp:Label ID="userReenternewpassword" runat="server" Text="Re-Enter Password"></asp:Label>
        <asp:TextBox ID="usertextReenterpassword" runat="server" CssClass="form-control" placeholder="Re-Enter Password" Width="100%"></asp:TextBox>
&nbsp;&nbsp;
        <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="usertextenterpassword" ControlToValidate="usertextReenterpassword" ErrorMessage="Password Should be Same" ForeColor="#CC3300"> * Password Should be Same</asp:CompareValidator>
        <br />
       
        
     
      
        <asp:Button ID="userforgetsubmitbtn" runat="server"  Text="Submit"  CssClass="btn btn-info btn-lg btn-block" Width="100%" OnClick="userforgetsubmitbtn_Click" />
   <br />
...
<%--       <asp:Button ID="Button1" CssClass="btn btn-info btn-lg" runat="server" Text="Login" OnClick="Button1_Click1"/>--%>
       <asp:Label ID="allFieldShow" runat="server" Text=""></asp:Label>
                    ...
                    <br />
      <br />
      <asp:Label ID="userchangepasswordlabel" runat="server"></asp:Label>
