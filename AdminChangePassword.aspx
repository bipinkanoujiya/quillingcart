<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminChangePassword.aspx.cs" Inherits="AdminChangePassword" %>
 ...
 <asp:Button ID=handcrafttextbutton runat="server" Text="Subscribe" CssClass="btn btn-info btn-lg" Width="110" Height="40" ForeColor="White"></asp:Button>
        ...
        <style>
          ...
          margin-bottom:10px;
            ...
            #entername,#enterpassword,#reenterpassword,#labelage,#emailid,#labeladdress,#Country,#states,#Pincode {
 ...
 .section-header .section-title {
   ...
   margin-top:100px;
    ...
    border-radius:25px;
            ...
            #textboxname,#textpassword ,#textreenterpassword,#textage,#textage,#textemail,#Countries,#states,#PinTextBox{
                height: 34px;
                padding: 6px 12px;
                border-radius:5px;
            }
...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="textboxname" ErrorMessage="Enter Name" ForeColor="#CC0000">* Required Field</asp:RequiredFieldValidator>
       <br />
     
        <asp:Label ID="labelage" runat="server" Text="Mobile"></asp:Label>
        <asp:TextBox ID="textage" runat="server" CssClass="form-control" placeholder="Enter Mobile" Width="100%"></asp:TextBox>
&nbsp;&nbsp;
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="textage" ErrorMessage="Enter Mobile Number" ForeColor="#CC0000">*Required Field</asp:RequiredFieldValidator>
        <br />
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="textemail" ErrorMessage="Enter Email " ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ForeColor="#CC0000">  Email should be as Bipinkanouj8@gmail.com</asp:RegularExpressionValidator>
       
        <br />
     
      
        <asp:Button ID="Adminchangesubmitbtn" runat="server"  Text="Submit"  CssClass="btn btn-info btn-lg btn-block" Width="100%" OnClick="changesubmitbtn_Click" />
   <br />
